...
class TestFactorInvoice(AccountTestInvoicingCommon):
    ...
    def setUpClass(cls):
        ...
        cls.payment_method_line_factor = cls.env[
        ...
        ].create(
            {
                ...
                "journal_id": cls.journal_factor.id,
                "selectable": True,
            }
        )
        ...
        cls.factor_inv.preferred_payment_method_line_id = (
            cls.payment_method_line_factor
        )
    ...
    def test_non_factor_customer_invoice(self):
        ...
        """
        normal_inv = self.factor_inv.copy(
