    ...
    def _compute_payment_state_with_factor(self):
        for move in self:
            if (
                ...
                and move.preferred_payment_method_line_id
                and move.preferred_payment_method_line_id.journal_id
                and move.preferred_payment_method_line_id.journal_id.is_factor
            ):
    ...
    def button_cancel_factor(self):
        for inv in self:
            ...
            if inv.factor_transfer_id and inv.factor_transfer_id.state in (
                ...
                inv.preferred_payment_method_line_id = False
